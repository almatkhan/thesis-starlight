...
export class Router {
	...
	addRoutes() {
		...
		router.post("/vault", this.serviceMgr.service_vault.bind(this.serviceMgr));

		router.post("/send", this.serviceMgr.service_send.bind(this.serviceMgr));

		router.post(
			"/unVault",
			this.serviceMgr.service_unVault.bind(this.serviceMgr)
		);
